<nav x-data="{ open: false }" class="bg-white/80 border-b border-cream-200 dark:bg-navy-700/80 dark:border-navy-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-3">
                <button @click="toggle()" class="p-2 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-cream-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-navy-800 transition-colors" title="Toggle dark mode">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150 dark:bg-navy-700 dark:text-gray-400 dark:hover:text-white">
            ...
            <div class="-me-2 flex items-center sm:hidden gap-2">
                ...
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-cream-100 focus:outline-none focus:bg-cream-100 focus:text-gray-500 transition duration-150 ease-in-out dark:hover:bg-navy-800 dark:hover:text-gray-300">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-cream-200 dark:border-navy-800">
            <div class="px-4">
