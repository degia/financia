                ...
                <form method="POST" action="{{ route('institutions.update', $institution) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        @if ($institution->logo_url)
                            <div class="mb-2">
                                <img src="{{ $institution->logo_url }}" alt="{{ $institution->name }}" class="w-14 h-14 object-contain rounded-lg border border-gray-200 dark:border-gray-700">
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Current logo. Upload a new one to replace it.</p>
                            </div>
                        @endif
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">PNG, JPG, SVG, or WebP. Max 1MB. Leave empty to keep current.</p>
